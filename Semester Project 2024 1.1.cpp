...
int main() {
    // Use of srand to give the function a new beginning or seed rather.
    srand(time(0));
    School school;

//The main menu when first user logins in.
// Use of the switch case.
    int choice;
    do {
        cout << "Welcome to the Strathmore Co-Curricular Menu:\n";
        cout << "1. Add student.\n";
        ...
        cout << "7. Register for activities.\n";
        ...
        switch (choice) {
            ...
            case 3: viewClubs(school); break;
            case 4: viewSports(school); break;
            case 5: viewGroups(); break;
            case 6: save(); break;
            case 7: registerForActivities(school); break;
            case 8: break;
